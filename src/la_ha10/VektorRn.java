...
public class VektorRn {
	...
	/**
	 * Speichert die Elemente des Vektors und gibt durch die Größe die Dimension
	 * vor
	 */
	 ...
	 * @param komponente 
	 * 				Index der Komponente, die zurückgegeben werden soll (beginnend bei 0)
	 ...
	 * @param komponente 
	 * 				Index der Komponente, die verändert werden soll
	...
	/**
	 * Berechnet das Standardskalarprodukt für 2 Vektoren
	 * 
	 * @param v1
	...
	/**
	 * Berechnet den Winkel zwischen Vektor v1 und v2 (Ausgabe im Bogenmaß)
	 * 
	 * @param v1
	 *            Erster Vektor für den Winkel
	 * @param v2
	 *            Zweiter Vektor für den Winkel
